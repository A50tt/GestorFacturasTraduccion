...
public class BuscarFacturaController implements Controller {
    ...
    public static final String VIEW_NAME = "Buscar factura";
    ...
    protected void initialize() {
        ...
        ignoreCaseCheckBox = invoiceLookupView.ignoreCaseCheckBox;
        lookupAllInvoices();
    }
    ...
    public void lookupInvoice() {
        ...
        if (campoActual.equals(tiposCampo[0])) {
            ...
            listaFacturasFiltradas = JSONUtils.getFacturasByFilter(valor, campoFiltro, ignoreCaseCheckBox.isSelected());
            ...
            campoFiltro = "id";
            listaFacturasFiltradas = JSONUtils.getFacturasByClienteFilter(valor, campoFiltro, ignoreCaseCheckBox.isSelected());
